...
/**
 * Check if stock amounts should be integers.
 *
 * @since 3.0.0
 * @return bool True if stock amounts are integers, false otherwise.
 */
function wc_is_stock_amount_integer() {
	return apply_filters( 'woocommerce_stock_amount_is_integer', true );
}
